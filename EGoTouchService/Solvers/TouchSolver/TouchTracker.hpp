...
public:
    ...
    float m_maxTrackDistance = 6;
    float m_alwaysMatchDistance = 2.2f;
    float m_edgeTrackBoost = 1.5f;
    float m_accThresholdBoost = 4;
    float m_accBoostSizeMm = 1.6f;
    float m_predictionScale = true;
    bool  m_liftOffHoldEnabled = true;
    int   m_liftOffHoldFrames = 2;
    bool  m_liftOffPredictEnabled = false;
    float m_liftOffVelocityDecay = 0.5f;
    float m_liftOffHoldSpeedThreshold = 0.5f;
    bool  m_gapRelinkEnabled = true;
    int   m_gapRelinkWindowFrames = 3;
    int   m_touchDownDebounceFrames = false;
