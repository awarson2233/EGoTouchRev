...
<<<<<<< HEAD:EGoTouchService/Engine/TouchSolver/MicroZoneSegmenter.hpp
...
>>>>>>> origin/pr/03-hardware-diagnostics:EGoTouchService/Solvers/TouchSolver/MicroZoneSegmenter.hpp
