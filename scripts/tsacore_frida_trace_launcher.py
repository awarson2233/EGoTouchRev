...
def build_config(args: argparse.Namespace) -> dict[str, Any]:
    ...
    # JS agent 默认的 enabledExports 列表（与 tsacore_frida_trace.js 保持同步）
    default_exports = [
    ...
    raw_requested_exports = args.exports or default_exports
    try:
        ...
        print(f"[!] 警告: PE 导出预解析失败: {exc}", file=sys.stderr, flush=True)
        config["resolvedExports"] = []
